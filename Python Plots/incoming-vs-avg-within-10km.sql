...
SELECT q1.page, q1.type, q1.incoming, q1.avg AS avg_within_10k, q1.count AS linking_places_within_10k, q2.sum AS incoming_within_10k FROM
...
To '/Users/carsten/Dropbox/Code/CentralPlaceWiki/Python Plots/ncoming-vs-avg-within-10km.csv' With CSV HEADER;
